...
$(NAME): ${INC} ${OBJS}
	@gcc $(CFLAGS) ${OBJS} -lm -L. -lmlx -L/usr/include/../lib -lXext -lX11 -lm -lbsd -I Includes/ -o Cub3D

%.o : %.c
	@gcc $(CFLAGS) -c -lm -L. -lmlx -L/usr/include/../lib -lXext -lX11 -lm -lbsd  -I Includes/ $< -o $@
