...
/*   Updated: 2020/08/06 14:36:10 by ade-temm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int ac, char **av)
{
	...
	ft_get_sprite(tab);
	mlx_hook(tab->mlx.win, 2, 1L << 0, appuyer, tab);
	mlx_hook(tab->mlx.win, 3, 1L << 1, relacher, tab);
	mlx_hook(tab->mlx.win, 17, 1L << 5, ft_close, tab);
